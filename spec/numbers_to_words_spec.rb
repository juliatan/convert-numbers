...
describe 'When converting numbers to words' do
  ...
  context 'ten thousands' do
    ...
    it 'can convert 21000 to twenty one thousand' do
      expect(convert(21000)).to eq 'twenty one thousand'
    end
  ...
  context 'hundred thousands' do
    ...
    it 'can convert 101000 to one hundred and one thousand' do
      expect(convert(101000)).to eq 'one hundred and one thousand'
    end

    it 'can convert 101001 to one hundred and one thousand and one' do
      expect(convert(101001)).to eq 'one hundred and one thousand and one'
    end
